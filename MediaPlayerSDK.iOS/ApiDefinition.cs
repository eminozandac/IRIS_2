...
namespace MediaPlayerSDK.iOS
{
	...
	interface MediaPlayer
	{
		...
		void Open (MediaPlayerConfig config, [NullAllowed] MediaPlayerCallback callback);
		...
		unsafe void GetViewSizesAndVideoAspects(ref int view_orientation, ref int view_width, ref int view_height, ref int video_width, ref int video_height,
		                                        ref int aspect_left, ref int aspect_top, ref int aspect_width, ref int aspect_height, ref int aspect_zoom);
