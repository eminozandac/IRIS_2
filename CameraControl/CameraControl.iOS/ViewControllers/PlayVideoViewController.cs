...
{
    public partial class PlayVideoViewController : UIViewController
    {
        public PlayVideoViewController() : base("PlayVideoViewController", null)
        {
        }

		protected PlayVideoViewController(IntPtr handle) : base(handle)
		{
